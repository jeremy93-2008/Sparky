...
/*
     ...
     */
function f(){"isConnected"in Node.prototype||Object.defineProperty(Node.prototype,"isConnected",{get:function(){return!(this.ownerDocument&&this.ownerDocument.compareDocumentPosition(this)&this.DOCUMENT_POSITION_DISCONNECTED)}})}Array.from||(Array.from=(a=Object.prototype.toString,i=function(e){return"function"==typeof e||"[object Function]"===a.call(e)},c=Math.pow(2,53)-1,u=function(e){var t,n=(t=Number(e),isNaN(t)?0:0!==t&&isFinite(t)?(0<t?1:-1)*Math.floor(Math.abs(t)):t);return Math.min(Math.max(n,0),c)},function(e){var t=Object(e);if(null==e)throw new TypeError("Array.from requires an array-like object - not null or undefined");var n,r=1<arguments.length?arguments[1]:void 0;if(void 0!==r){if(!i(r))throw new TypeError("Array.from: when provided, the second argument must be a function");2<arguments.length&&(n=arguments[2])}for(var o,a=u(t.length),c=i(this)?Object(new this(a)):new Array(a),s=0;s<a;)o=t[s],c[s]=r?void 0===n?r(o,s):r.call(n,o,s):o,s+=1;return c.length=a,c})),Array.prototype.find||(Array.prototype.find=function(e){if(null==this)throw new TypeError("Array.prototype.find called on null or undefined");if("function"!=typeof e)throw new TypeError("predicate must be a function");for(var t=Object(this),n=t.length>>>0,r=arguments[1],o=void 0,a=0;a<n;a++)if(o=t[a],e.call(r,o,a,t))return o}),f();var d=/** @class */function(){function e(){}return e.listen=function(t){var n=this;e.removeUnusedEvents();var r=this.eventList||t;r.forEach((function(e){var t=e.type;n.isEventTypeListening(t)||(document.addEventListener(t,(function(e){return n.dispatchEvent(e,r)})),n.eventListType.push(t))}))},e.dispatchEvent=function(e,t){var n=this;t.find((function(t){n.isEventTarget(t,e)&&t.type===e.type&&t.callbackFn(e)}))},e.addEvent=function(e){var t=e.dom,n=e.type,r=e.context,o=e.callbackFn;this.eventList.push({dom:t,type:n,context:r,callbackFn:o})},e.removeUnusedEvents=function(){this.eventList=this.eventList.filter((function(e){return e.dom.isConnected}))},e.isEventTypeListening=function(e){return this.eventListType.find((function(t){return t==e}))},e.isEventTarget=function(e,t){return e.dom===t.target||e.dom.contains(t.target)},e.oldEventType=[],e.eventList=[],e.eventListType=[],e}(),l=null;function p(){return l}function h(e){l=e}function m(e,t){if(!t)return null;if(!e&&t)return t;if(e.isEqualNode(t))return e;if(e.nodeName!==t.nodeName)return t;for(var n=[[e,t]],r=function(){var e=n.shift(),t=e[0],r=e[1],o=[];!function(e,t){if(!e.attributes||!t.attributes)return;var n=Array.from(e.attributes).sort((function(e,t){return y(e,t)})),r=Array.from(t.attributes).sort((function(e,t){return y(e,t)})),o=[];n.forEach((function(t,n){var a=r[n];if(a)return t.name!==a.name?(o.push(t),void e.setAttribute(a.name,a.value)):void(t.value!==a.value&&(t.value=a.value));o.push(t)}));for(var a=n.length;a<r.length;a++){var i=r[a];e.setAttribute(i.name,i.value)}o.forEach((function(t){return e.removeAttribute(t.name)}))}(t,r);var a=r.childNodes;t.childNodes.forEach((function(e,r){var i=a.item(r);i?e.isEqualNode(i)||(e.nodeName===i.nodeName?"#text"!=e.nodeName||e.textContent===i.textContent?(i.__sparkyEventIndex&&(d.eventList[i.__sparkyEventIndex].dom=e),n.push([e,i])):e.textContent=i.textContent:t.replaceChild(i.cloneNode(!0),e)):o.push(e)}));for(var i=t.childNodes.length;i<r.childNodes.length;i++){var c=r.childNodes.item(i);t.appendChild(c.cloneNode(!0))}o.forEach((function(e){t.removeChild(e)}))};n.length>0;)r();return e}function y(e,t){return e.name<t.name?-1:e.name>t.name?1:0}var v=Object.prototype.toString,x=function(e){if(void 0===e)return"undefined";if(null===e)return"null";var t=typeof e;if("boolean"===t)return"boolean";if("string"===t)return"string";if("number"===t)return"number";if("symbol"===t)return"symbol";if("function"===t)return"GeneratorFunction"===g(e)?"generatorfunction":"function";if(function(e){return Array.isArray?Array.isArray(e):e instanceof Array}(e))return"array";if(
/**
...
/**
     * Expose `cloneDeep`
     */(e,t);default:return w(e)}}var _=E,A={__root:null,__id:"",props:{},state:{},cachedMemo:[],cachedUpdate:[],cachedState:[],indexes:{memo:0,update:0,state:0},renderFunc:null},S=/** @class */function(){function e(){}return e.getCurrentContext=function(){return this.__context},e.setCurrentContext=function(e){this.__context=e},e.resetIndexes=function(){if(!this.__context)throw new ReferenceError("Try to reset index on a undefined context");this.__context.indexes.memo=0,this.__context.indexes.update=0,this.__context.indexes.state=0},e.newContext=function(e){return _(t(t(t({},this.__defaultContext),e),{__id:s(12)}))},e.__defaultContext=A,e}();function T(e,t,r,o,a){var i=r[function(e,t){return"memoize"==t?e.indexes.memo:e.indexes.update}(e,t)];!function(e,t){"memoize"==t?++e.indexes.memo:++e.indexes.update}(e,t);var c,u,s,f,d={fn:o,result:null,dependencies:a};return i&&a?(c=i.dependencies,u=function(e,t){var n=e.length,r=t.length;return n>r?{bigArray:e,smallArray:t}:{bigArray:t,smallArray:e}}(c,a),s=u.bigArray,f=u.smallArray,s.every((function(e,t){return e==(f?f[t]:null)}))||(i.dependencies=a,i.result=o.call.apply(o,n([window],a))),i.result):(d.result=o.call(window,a?n(a):null),r.push(d),d.result)}window.requestIdleCallback=window.requestIdleCallback||function(e){var t=Date.now();return setTimeout((function(){e({didTimeout:!1,timeRemaining:function(){return Math.max(0,50-(Date.now()-t))}})}),1)},window.cancelIdleCallback=window.cancelIdleCallback||function(e){clearTimeout(e)};var j=function(){var e=S.getCurrentContext();if(!e)throw new ReferenceError("Sparky Function only can be used in the lifecycle of a Sparky application");return e},k=function(e){var n;n=this.context,S.setCurrentContext(n),S.resetIndexes();var r=j();return r.indexes.state=this.state,r.cachedState[r.indexes.state]=e,r.indexes.state++,r.__root?S.setCurrentContext(U.mount(t(t({},r.__root),{currentContext:r}))):S.setCurrentContext(U.mount({type:"SparkyComponent",context:r,currentContext:r,renderFn:r.renderFunc})),k},F=0,I=[],N=[];function O(e,t){window.requestIdleCallback((function(){window.addEventListener("hashchange",(function(n){if(n.oldURL!=n.newURL){var r=L(e,location.hash);D(r),r&&t(r.component)}}))}))}function L(e,t){return e.find((function(e,n){return e.path instanceof RegExp?(F=n,t.search(e.path)):"string"==typeof e.path&&(F=n,t.includes(e.path))}))||e[0]}function D(e){F<N.length-1&&(N=N.slice(0,F+1)),N.push(e),F=N.length-1}function M(e){I=e}f();var U=/** @class */function(){function e(){}
/**
...
/**
         ...
         * @param stateRoute
         */
e.router=function(t,n){O(t,(function(t){e.mount(t)}));var r=L(t,location.hash);return M(t),D(r),r.component},
/**
         ...
         */
e.mount=function(n,r){e._DEV_&&console.time();var o=n.context,a=n.renderFn,i=_(n.currentContext.indexes);S.setCurrentContext(o),S.resetIndexes();var c=a(Object.freeze(o.props)),u=R(c.html);u=P.populate(u,c,n);var s=m(p(),u);if(s)return!s.isConnected&&r&&r.appendChild(s),d.listen(thisTestEvent),h(s),e._DEV_&&console.timeEnd(),"undefined"!=typeof thisTest&&thisTest.testing&&(thisTest.__testUtilData={root:p(),component:n,eventList:thisTestEvent}),t(t({},n.currentContext),{indexes:i})},
/**
         ...
         */
e.reconciliate=function(e,t){return m(e,t)},e._DEV_=!0,e}();function R(e){var t=document.createElement("div");if(t.innerHTML=e,t.children.length>1)throw new TypeError("Adjacent elements on the root level are forbidden.");return t.firstElementChild}String.prototype.startsWith||(String.prototype.startsWith=function(e,t){return t=t||0,this.substr(t,e.length)===e});var P=/** @class */function(){function e(){}return e.populate=function(e,t,n){for(var r=this,o=[[t,n,e]],a=0,i=function(){var e=o.shift(),i=e[0],u=e[1],s=e[2];c.cachedComponent[a]||(c.cachedComponent[a]=[]),i.func.forEach((function(e,t){var n=function(e,t,n){for(var r=[e];r.length>0;){var o=r.shift(),a=Array.from(o.attributes).find((function(e){if(e.name.startsWith("on"))return e.value=="SparkyFunction#"+t+"#"+n}));if(a)return{dom:o,attr:a};for(var i=0;i<o.children.length;i++)r.push(o.children[i])}}(s,i.renderId,t),r=n.attr.name.replace("on","");n.dom.__sparkyEventIndex=d.eventList.length,d.addEvent({dom:n.dom,type:r,context:u.context,callbackFn:e.func}),n.dom.removeAttribute(n.attr.name)})),i.children.forEach((function(e){o.push([e,u,s])})),i.nestedComponents.forEach((function(e,c){var u,f=r.cachedComponent[a][c],d=r.findComment(s,i.renderId,c,e.renderFn.name);f&&(""==f.component.renderFn.name?f.component.renderFn.toString()==e.renderFn.toString()&&(e=q(f,e)):f.component.renderFn.name==e.renderFn.name&&(e=q(f,e))),S.setCurrentContext(e.context),S.resetIndexes();var l=e.renderFn(Object.freeze(e.context.props));if(d){var p=R(l.html);d.parentNode.replaceChild(p,d),e.context.__root=n,(u=t.func).push.apply(u,l.func),o.push([l,e,p]),r.cachedComponent[a][c]={component:e,dom:s}}})),i.nestedComponents.length>0&&a++},c=this;o.length>0;)i();return window.thisTestEvent=d.eventList,e},e.findComment=function(e,t,n,r){for(var o=[e];o.length>0;){var a=o.shift();if("#comment"==a.nodeName&&a.nodeValue.trim()=="SparkyComponent#"+r+"#"+n+"#"+t)return a;for(var i=0;i<a.childNodes.length;i++)o.push(a.childNodes[i])}},e.cachedComponent=[],e}();function q(e,t){return e.component.context.props=t.context.props,t=e.component}f();var z=/** @class */function(){function e(){}
/**
         * Generate a Sparky Component that can be mount.
         * @param renderFunc The function that going to be execute to render html template
         */return e.component=function(e,t){var n=S.newContext({props:t,renderFunc:e});return{type:"SparkyComponent",context:n,currentContext:n,renderFn:e}},
...
/**
         ...
         * @param dom The dom element where you want to mount this component
         */
e.mount=function(n,r){e._DEV_&&console.time();var o=n.context,a=n.renderFn,i=_(n.currentContext.indexes);S.setCurrentContext(o),S.resetIndexes();var c=a(Object.freeze(o.props)),u=K(c.html);u=P.populate(u,c,n);var s=m(p(),u);if(s)return!s.isConnected&&r&&r.appendChild(s),d.listen(thisTestEvent),h(s),e._DEV_&&console.timeEnd(),"undefined"!=typeof thisTest&&thisTest.testing&&(thisTest.__testUtilData={root:p(),component:n,eventList:thisTestEvent}),t(t({},n.currentContext),{indexes:i})},
/**
         * Reconciliate the current DOM with the new DOM Node
         * @param oldNode Node that need to be reconcile
         * @param newNode Node that have the new elements
         */
e.reconciliate=function(e,t){return m(e,t)},e._DEV_=!0,e}(),V=function(e,t){var n=j();window.requestIdleCallback((function(){T(n,"update",n.cachedUpdate,e,t)}),{timeout:250})},B=function(e){var t=j(),n={context:t,state:t.indexes.state},r=t.cachedState[t.indexes.state];if(r)return t.indexes.state++,[r,k.bind(n)];var o=function(e){var t=j();return t.cachedState[t.indexes.state]=e,k}(e);t.indexes.state++;var a=t.indexes.state-1;return[t.cachedState[a],o.bind(n)]},W=function(e,t){var n=j();T(n,"memoize",n.cachedMemo,e,t)},H=function(e){var t=L(I,e);D(t),U.mount(t.component)},G=function(){if(!(F-1<0)){var e=N[--F];U.mount(e.component)}},$=function(){if(!(F+1>N.length-1)){var e=N[++F];U.mount(e.component)}};
/**
     ...
     */function J(e,t,n,r,o,a,i){if("function"==typeof e[t])n.push({index:n.length-1,renderId:i,func:e[t]}),r+="'SparkyFunction#"+i+"#"+(n.length-1)+"'";else if("SparkyRender"==e[t].type){var c=e[t];r+=c.html,a.push(c)}else if("SparkyComponent"==e[t].type){var u=e[t];r+="\x3c!-- SparkyComponent#"+u.renderFn.name+"#"+o.length+"#"+i+" --\x3e",o.push(u)}else e[t]=Array.isArray(e[t])?e[t].join(""):new String(e[t]),e[t].startsWith("<")?r+=e[t]:r+="<span class='computed'>"+e[t]+"</span>";return r}function K(e){var t=document.createElement("div");if(t.innerHTML=e,t.children.length>1)throw new TypeError("Adjacent elements on the root level are forbidden.");return t.firstElementChild}e.Sparky=z,e.goBack=G,e.goForward=$,e.goToState=H,e.memoize=W,e.render=
/**
     ...
     */
function(e){for(var t=[],n=1;n<arguments.length;n++)t[n-1]=arguments[n];var r=[],o=[],a=[],i=s(12),c="string"==typeof e?e:e.map((function(e,n){var c="";return c+=e,t[n]?c=J(t,n,r,c,o,a,i):c})),u=Array.isArray(c)?c.join(""):c;return{type:"SparkyRender",html:u,func:r,nestedComponents:o,children:a,renderId:i}},e.renderToDOMNode=K,e.state=B,e.update=V,Object.defineProperty(e,"__esModule",{value:!0})}));
