...
/*
     ...
     */function h(){"isConnected"in Node.prototype||Object.defineProperty(Node.prototype,"isConnected",{get:function(){return!(this.ownerDocument&&this.ownerDocument.compareDocumentPosition(this)&this.DOCUMENT_POSITION_DISCONNECTED)}})}h();var y=/** @class */function(){function e(){}return e.listen=function(){var t=this;e.removeUnusedEvents(),this.eventList.forEach((function(e){var n=e.type;t.isEventTypeListening(n)||(document.addEventListener(n,(function(e){return t.dispatchEvent(e)})),t.eventListType.push(n))}))},e.dispatchEvent=function(e){var t=this;this.eventList.find((function(n){t.isEventTarget(n,e)&&n.type===e.type&&n.callbackFn(e)}))},e.addEvent=function(e){var t=e.dom,n=e.type,r=e.context,o=e.callbackFn;this.eventList.push({dom:t,type:n,context:r,callbackFn:o})},e.removeUnusedEvents=function(){this.eventList=this.eventList.filter((function(e){return e.dom.isConnected}))},e.isEventTypeListening=function(e){return this.eventListType.find((function(t){return t==e}))},e.isEventTarget=function(e,t){return e.dom===t.target||e.dom.contains(t.target)},e.oldEventType=[],e.eventList=[],e.eventListType=[],e}(),v=Object.prototype.toString,x=function(e){if(void 0===e)return"undefined";if(null===e)return"null";var t=typeof e;if("boolean"===t)return"boolean";if("string"===t)return"string";if("number"===t)return"number";if("symbol"===t)return"symbol";if("function"===t)return"GeneratorFunction"===b(e)?"generatorfunction":"function";if(function(e){return Array.isArray?Array.isArray(e):e instanceof Array}(e))return"array";if(
/**
...
/*!
     ...
     */(e))return"buffer";if(function(e){try{if("number"==typeof e.length&&"function"==typeof e.callee)return!0}catch(e){if(-1!==e.message.indexOf("callee"))return!0}return!1}(e))return"arguments";if(function(e){return e instanceof Date||"function"==typeof e.toDateString&&"function"==typeof e.getDate&&"function"==typeof e.setDate}(e))return"date";if(function(e){return e instanceof Error||"string"==typeof e.message&&e.constructor&&"number"==typeof e.constructor.stackTraceLimit}(e))return"error";if(function(e){return e instanceof RegExp||"string"==typeof e.flags&&"boolean"==typeof e.ignoreCase&&"boolean"==typeof e.multiline&&"boolean"==typeof e.global}(e))return"regexp";switch(b(e)){case"Symbol":return"symbol";case"Promise":return"promise";
...
// other
return t.slice(8,-1).toLowerCase().replace(/\s/g,"")};function b(e){return"function"==typeof e.constructor?e.constructor.name:null}function g(e){return!0==(null!=(t=e)&&"object"==typeof t&&!1===Array.isArray(t))&&"[object Object]"===Object.prototype.toString.call(e);var t}const C=Symbol.prototype.valueOf;
/**
     * Expose `clone`
     */
...
/**
     * Module dependenices
     */function A(e,t){switch(x(e)){case"object":return function(e,t){if("function"==typeof t)return t(e);if(t||(n=e,!1!==g(n)&&"function"==typeof(
// If has modified constructor
r=n.constructor)&&!1!==g(
// If has modified prototype
o=r.prototype)&&!1!==o.hasOwnProperty("isPrototypeOf"))){const n=new e.constructor;for(let r in e)n[r]=A(e[r],t);return n}var n,r,o;return e}(e,t);case"array":return function(e,t){const n=new e.constructor(e.length);for(let r=0;r<e.length;r++)n[r]=A(e[r],t);return n}
/**
     * Expose `cloneDeep`
     */(e,t);default:return w(e)}}var E=A,_={__root:null,__id:"",props:{},state:{},cachedMemo:[],cachedUpdate:[],cachedState:[],indexes:{memo:0,update:0,state:0},renderFunc:null},S=/** @class */function(){function e(){}return e.getCurrentContext=function(){return this.__context},e.setCurrentContext=function(e){this.__context=e},e.resetIndexes=function(){if(!this.__context)throw new ReferenceError("Try to reset index on a undefined context");this.__context.indexes.memo=0,this.__context.indexes.update=0,this.__context.indexes.state=0},e.newContext=function(e){return E(t(t(t({},this.__defaultContext),e),{__id:s(12)}))},e.__defaultContext=_,e}();function j(e,t,r,o,a){var i=r[function(e,t){return"memoize"==t?e.indexes.memo:e.indexes.update}(e,t)];!function(e,t){"memoize"==t?++e.indexes.memo:++e.indexes.update}(e,t);var c,u,s,f,l={fn:o,result:null,dependencies:a};return i&&a?(c=i.dependencies,u=function(e,t){var n=e.length,r=t.length;return n>r?{bigArray:e,smallArray:t}:{bigArray:t,smallArray:e}}(c,a),s=u.bigArray,f=u.smallArray,s.every((function(e,t){return e==(f?f[t]:null)}))||(i.dependencies=a,i.result=o.call.apply(o,n([window],a))),i.result):(l.result=o.call(window,a?n(a):null),r.push(l),l.result)}window.requestIdleCallback=window.requestIdleCallback||function(e){var t=Date.now();return setTimeout((function(){e({didTimeout:!1,timeRemaining:function(){return Math.max(0,50-(Date.now()-t))}})}),1)},window.cancelIdleCallback=window.cancelIdleCallback||function(e){clearTimeout(e)};var k=function(){var e=S.getCurrentContext();if(!e)throw new ReferenceError("Sparky Function only can be used in the lifecycle of a Sparky application");return e},F=function(e){var n;n=this.context,S.setCurrentContext(n),S.resetIndexes();var r=k();return r.indexes.state=this.state,r.cachedState[r.indexes.state]=e,r.indexes.state++,r.__root?S.setCurrentContext(N.mount(t(t({},r.__root),{currentContext:r}))):S.setCurrentContext(N.mount({type:"SparkyComponent",context:r,currentContext:r,renderFn:r.renderFunc})),F};h();var N=/** @class */function(){function e(){}
/**
...
/**
         ...
         */
e.mount=function(n,r){e._DEV_&&console.time();var o=n.context,a=n.renderFn,i=E(n.currentContext.indexes);S.setCurrentContext(o),S.resetIndexes();var c=a(Object.freeze(o.props)),u=O(c.html);u=I.populate(u,c,n);var s=p(l(),u);if(s)return!s.isConnected&&r&&r.appendChild(s),y.listen(),d(s),e._DEV_&&console.timeEnd(),t(t({},n.currentContext),{indexes:i})},
/**
...
/**
         ...
         * @param dom The dom element where you want to mount this component
         */
e.mount=function(n,r){e._DEV_&&console.time();var o=n.context,a=n.renderFn,i=E(n.currentContext.indexes);S.setCurrentContext(o),S.resetIndexes();var c=a(Object.freeze(o.props)),u=z(c.html);u=I.populate(u,c,n);var s=p(l(),u);if(s)return!s.isConnected&&r&&r.appendChild(s),y.listen(),d(s),e._DEV_&&console.timeEnd(),t(t({},n.currentContext),{indexes:i})},
/**
         * Reconciliate the current DOM with the new DOM Node
         * @param oldNode Node that need to be reconcile
         * @param newNode Node that have the new elements
         */
e.reconciliate=function(e,t){return p(e,t)},e._DEV_=!0,e}(),M=function(e,t){var n=k();window.requestIdleCallback((function(){j(n,"update",n.cachedUpdate,e,t)}),{timeout:250})},L=function(e){var t=k(),n={context:t,state:t.indexes.state},r=t.cachedState[t.indexes.state];if(r)return t.indexes.state++,[r,F.bind(n)];var o=function(e){var t=k();return t.cachedState[t.indexes.state]=e,F}(e);t.indexes.state++;var a=t.indexes.state-1;return[t.cachedState[a],o.bind(n)]},U=function(e,t){var n=k();j(n,"memoize",n.cachedMemo,e,t)};
/**
